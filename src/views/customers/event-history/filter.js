...
export default function FilterCustomersEventHistory({ open, count, params, setParams, onClose, pelangganNama }) {
        ...
        <MainCard
          ...
          title={
            <Stack direction="row" alignItems="center" justifyContent="space-between">
              <Stack>
                <Typography variant="body1">Filter Event History</Typography>
                <Typography variant="caption">{count} data ditemukan</Typography>
              </Stack>
              <IconButton aria-label="tutup-filter" color="error" onClick={onClose}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                InputLabelProps={{ shrink: true }}
                inputProps={{ min: params.startdate }}
              />
            </Grid>
            <Grid item xs={12}>
              <Autocomplete
                ...
                renderInput={(inputParams) => <TextField {...inputParams} label="ID Unit" />}
              />
            </Grid>
            <Grid item xs={12}>
              <Autocomplete
