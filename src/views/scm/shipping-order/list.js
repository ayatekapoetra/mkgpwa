...
function ListShippingOrder({ columns, data, paginate }) {
              ...
              return (
                <TableRow key={ri} {...row.getRowProps()} hover>
                  {row.cells.map((cell, ci) => (
                    <TableCell key={ci} {...cell.getCellProps([{ className: cell.column.className }])}>{cell.render('Cell')}</TableCell>
                  ))}
                </TableRow>
              );
            })}
