...
export default function TopPemasokChart({ data, loading }) {
  if (loading) {
    return (
  ...
  const labels = topItems.map(item => {
    const name = item.pemasok_nama || 'N/A';
    const code = item.pemasok_kode || '';
