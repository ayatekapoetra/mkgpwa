...
export default function EquipmentSpendingChart({ data, loading }) {
  ...
  const labels = topItems.map(item => {
    const code = item.equipment_kode || 'N/A';
