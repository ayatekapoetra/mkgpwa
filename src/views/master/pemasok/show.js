...
import { Send2, Trash, User, Location, Call, Sms, Clock } from "iconsax-react";
...
export default function ShowPemasokScreen() {
  ...
  const onSubmitHandle = async (values) => {
    const { bisnis_id, bisnis, sts_sync, sts_sync_msg, createdby, created_at, updated_at, ...cleanValues } = values;
