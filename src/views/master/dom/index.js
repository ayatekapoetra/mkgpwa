...
const DomScreen = () => {
  ...
  const { data, dataLoading, dataError } = useDom(params);
  ...
  return (
    <>
      <Breadcrumbs custom heading={'Dom'} links={breadcrumbLinks} />
      <MainCard
        title={
          <Button variant="contained" component={Link} href="/dom/create">
            Add Dom
          </Button>
        }
        secondary={
