  ...
  return (
    <Fragment>
      ...
      <MainCard title={<BtnBack href={'/barang'} />} secondary={null} content={true}>
        <Formik initialValues={initialValues || { kode: '', nama: '', satuan: '', min_stok: 0, actual: 0 }} enableReinitialize={true} validationSchema={validationSchema} onSubmit={onSubmitHandle}>
