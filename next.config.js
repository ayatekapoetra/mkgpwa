...
const nextConfig = {
  ...
  env: {
    ...
    NEXTAUTH_URL: process.env.NODE_ENV === 'development' ? 'http://localhost:3005' : process.env.NEXTAUTH_URL || 'https://pwa.makkuragatama.com/',
    REACT_APP_GOOGLE_MAPS_API_KEY: 'AIzaSyAXv4RQK39CskcIB8fvM1Q7XCofZcLxUXw',
    NEXT_APP_API_URL: 'http://localhost:3003',
